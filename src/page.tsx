        ...
        <div className="hero-body">
          ...
          <div>
            <div className="mockphone-frame">
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: "800", fontSize: "1.1rem", marginBottom: "18px", letterSpacing: "-0.02em" }}>Today's Overview</div>
              <div style={{ background: "#eef3ff", padding: "14px 16px", borderRadius: "14px", marginBottom: "12px" }}>
                <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.72rem", color: "#7788aa", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "4px" }}>Health Score</div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.5rem", fontWeight: "800", color: "#0044DD" }}>Optimal ↑</div>
              </div>
              <div style={{ background: "#f0faf4", padding: "14px 16px", borderRadius: "14px", marginBottom: "12px" }}>
                <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.72rem", color: "#7788aa", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "4px" }}>Net Worth Track</div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.5rem", fontWeight: "800", color: "#1a9e55" }}>+12.4%</div>
              </div>
              <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.82rem", color: "#aaa", marginTop: "8px" }}>Running predictive twin tracks...</div>
            </div>
          </div>
        </div>
      </section>
